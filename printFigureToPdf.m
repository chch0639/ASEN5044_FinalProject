function printFigureToPdf(fileName, figureSize, units, extraSpace, figHandle)
    ...
    % Modified by Chris Chamberlain, 04 December 2015
    % Lines 48-54 were added to create a folder labeled 'Figures' in the
    ...
    % Create 'Figures' folder in working directory if one doesn't exist
    if exist('Figures') ~= 7
        mkdir('Figures');   
    end
    
	% Output the figure
	print(figHandle, '-dpdf', ['Figures/' fileName]);
